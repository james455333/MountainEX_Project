...
<!-- 		<script> -->
<!-- // 			alert("已完成登入，關閉本視窗將導向後台維護系統") -->
<!-- // 			document.location.href="../backup/Memberback.jsp"; -->
<!-- 		</script> -->
<%-- 	</c:if> --%>
...
<c:set var='functionCheck' value='logging' scope='session'/>
	...
	<div id="container">
		...
		<div id="content">
			<div id="barNav"></div>
			<form id="loginFrame" action="<c:url value='MemberBackupLoginServlet'></c:url>" method='post'>
